...
if(isFavorite) {
console.log(`My favorite food is ${type}!`)
} else {
...
var vegetables = ['potato', 'corn', 'zucchini', 'kale', 'carrots']
...
var fruits = ['blueberries', 'mangos', 'pineapple', 'strawberries', 'kiwi', 'bananas', 'duran' ]
...
//Key ideas: Location, Store #, Telephone #, Website link
